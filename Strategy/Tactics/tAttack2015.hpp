...
//    {
//        cout<<"stuck"<<endl;
//        if(botBallDist<2*BOT_BALL_THRESH)
//        {
//            if(fabs(normalizeAngle(state->homeAngle[botID]))>PI/2){iState=APPROACHING; break;}
//            else if(fabs(normalizeAngle(state->homeAngle[botID]))>PI/4)
//                    {
